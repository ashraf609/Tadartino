...
export const registerAction = (user) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      "http://13.48.149.62/api/user/register",
      user
    );
...
export const loginAction = (info) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      "http://13.48.149.62/api/user/login",
      info
    );
    console.log(data);
    console.warn(data);
  ...
  async (dispatch) => {
    ...
    try {
      const { data } = await axios.get(
        "http://13.48.149.62/api/user/personal",
        {
          headers: {
            token,
          },
...
export const get_all_users_action = () => async (dispatch) => {
  ...
  try {
    const { data } = await axios.get("http://13.48.149.62/api/user/get-users");
...
export const update_user_action = (token, info) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      "http://13.48.149.62/api/user/update-user-data",
      info,
      {
        headers: {
          token,
  ...
  async (dispatch) => {
    ...
    try {
      const { data } = await axios.delete(
        "http://13.48.149.62/api/user/delete-user",
        {
          headers: {
            token,
          },
...
export const logout_action = (token) => async (dispatch) => {
  ...
  try {
    const { data } = await axios.post("http://13.48.149.62/api/user/logout", {
      headers: {
        token,
      },
    });
