...
import { DELETE_USER_FAIL, DELETE_USER_REQUEST, DELETE_USER_SUCCESS, GET_PERSONAL_INFO_FAIL, GET_PERSONAL_INFO_REQUEST, GET_PERSONAL_INFO_SUCCESS, GET_USERS_FAIL, GET_USERS_REQUEST, GET_USERS_SUCCESS, LOGOUT_FAIL, LOGOUT_REQUEST, LOGOUT_SUCCESS, UPDATE_USER_FAIL, UPDATE_USER_REQUEST, UPDATE_USER_SUCCESS, USER_LOGIN_FAIL, USER_LOGIN_REQUEST, USER_LOGIN_SUCCESS, USER_REGISTER_FAIL, USER_REGISTER_REQUEST, USER_REGISTER_SUCCESS } from '../Constants/UserConstants'
...
//get all users
export const get_personal_info_action=(token,id=null)=>async dispatch=>{
...
export const update_user_action=(token,info)=>async dispatch=>{
    ...
    try {
        const {data} = await axios.post("/api/user/update-user-data",info,{
            headers:{
                token,
...
//delete user
export const delete_user_action=(token,id=null)=>async dispatch=>{
    dispatch({type:DELETE_USER_REQUEST})
    try {
        const {data} = await axios.delete("/api/user/delete-user",{
            headers:{
                token
            },
            params:{
